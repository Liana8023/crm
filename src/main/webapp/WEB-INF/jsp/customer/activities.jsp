...
<div id="activities">
	...
	<div>
		<table class="table table-hover">
			...
			<tbody>
				<c:forEach items="${activityInfo.list}" var="avtivity">

					<tr>
						<td>${avtivity.atvPlace}</td>
						<td>${avtivity.atvTitle}</td>
						<td>${avtivity.atvMemo}</td>
						<td><i value="${avtivity.atvId}"class="layui-icon layui-icon-edit editUser" title="编辑"></i>
							<i value="${avtivity.atvId}" class="layui-icon layui-icon-delete deleteUser" title="删除"></i>
						</td>
					</tr>
				</c:forEach>
			</tbody>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.btn-primary').click(function(){
			var url = "activity/deleteActicityById/"+atvId;
			$(".layui-body").load(url);
			alert("删除成功");
			$('#deleteModal').hide();
		})
