...
<div id="service">
  ...
  <div class="form-group">
    <input name = "svrCustName" type="text" class="form-control" id="exampleInputEmail3" placeholder="请输入客户名称">
  </div>
	...
	$(function(){
		...
		$('.layui-icon-face-smile').click(function(){
			serviceId = $(this).attr("value");
			 $('.layui-body').load('service/toServiceDetail/'+serviceId);  
		})
		// 点击新增显示模态框
		$('#add').click(function(){
			$(".form-control").val("");
		...
		$('.editUser').click(function(){
			...
			$.get(url,function(data){
				...
				$("input[name=custName]").val(data.svrCustName);
