		  ...
		  <c:forEach items="${chanceInfo.list}" var="chance">
		    <tr>
		     <td>${chance.chcId}</td>
		      ...
		      <td>
		      	<i value="${chance.chcId}"  class="layui-icon layui-icon-edit editUser">编辑</i>  
		      	<i value="${chance.chcId}" class="layui-icon layui-icon-delete deleteUser">删除</i>   
		      </td>
		    </tr> 
		     </c:forEach> 
         </tbody>
    ...
    <div class="modal-content">
       <form>
					<div class="modal-body">
						...
						<div class="form-group">
							<label>客户名称:</label>
							<input type="text" name="chcCustName" class="form-control">
						</div>
						<div class="form-group">
							<label>成功几率:</label>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('button:contains(保存)').on('click',function(){
			...
			var url="chance/saveOrUpdateChance";
