...
public class RoleController {
	...
	@RequestMapping("/findAllRoles/{curPage}")
	public String findAllRoles(@PathVariable int curPage,HttpSession session){
		
		PageInfo<SysRole> roleInfo = roleService.findAllRoles(curPage, 5);
